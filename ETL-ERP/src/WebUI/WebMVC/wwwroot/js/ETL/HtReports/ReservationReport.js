$(document.body).on("click", "#ShowReportBtn", function () {
    ...
    const url = API + "BookingService/ReservationReport";
...
$(document.body).on("click", "#ReportPrintBtn", function () {
    ...
    //const model = { }
    console.log(model);
    const url = `${API}BookingService/ReservationReportPrint?fromDateStr=${model.FromDateStr}&toDateStr=${model.ToDateStr}&bookingNo=${model.BookingFilter}&guestName=${model.GuestFilter}`;
