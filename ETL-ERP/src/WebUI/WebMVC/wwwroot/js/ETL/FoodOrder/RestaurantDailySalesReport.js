$(document.body).on("click", "#ShowReportBtn", function () {
    ...
    const url = API + "FoodOrder/RsMonthlySalesReport";
...
$(document.body).on("click", "#ReportPrintBtn", function () {
    ...
    const url = `${API}FoodOrder/RsMonthlySalesReportPrint?fromDate=${model.StrFromDate}&toDate=${model.StrToDate}&customerId=${model.CustomerId}&customerTypeId=${model.CustomerTypeId}`;
