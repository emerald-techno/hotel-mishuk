$(document.body).on("click", "#ShowReportBtn", function () {
    ...
    const url = API + "InventoryReport/ItemConsumptionReport";
...
$(document.body).on("click", "#ReportPrintBtn", function () {
    ...
    const url = `${API}InventoryReport/ItemConsumptionReportPrint?strFromDate=${model.StrFromDate}&strToDate=${model.StrToDate}`;
