...
function serviceDateDifference() {
    ...
    days > 0 ? $("#days").val(days) : $("#days").val(0);
}
...
function renderInitRoomTableBody() {
    ...
    const checkInOutCell = `<td> 
                                <input class='form-control room-in-time' id='date-time-picker-in' type="text">
                                <input class='form-control room-out-time mt-2' id='date-time-picker-out' type="text">
