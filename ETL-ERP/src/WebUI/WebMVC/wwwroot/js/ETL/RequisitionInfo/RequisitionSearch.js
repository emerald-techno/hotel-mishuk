        ...
        "columns": [
            ...
            },
            {
                "render": function (data, type, item) {
                    ...
                    const viewBtn = `<a href='${API}RequsitionInfo/Details/${item.id}' style='margin-right:5px;'><i class="fa fa-eye"></i></a>`;
                    const deleteBtn = `<a href='${API}Designation/Delete/${item.id}' title='Delete'><i class="fa fa-trash"></i></a>`;

                    return `<div style='font-size:24px;'>${viewBtn}${editBtn}</div>`;
                }
            }
