...
function search() {
    ...
    if ($.fn.DataTable.isDataTable("#MyLeaveAppOnlineSearchTable")) {
        const table = $("#MyLeaveAppOnlineSearchTable").DataTable();
        table.destroy();
    }
    ...
    const oTable = $("#MyLeaveAppOnlineSearchTable").DataTable({
        ...
        "columns": [
            ...
            },
            {
                "render": function (data, type, item) {
                    ...
                    showTotalRowCountSpanInDataTable("MyLeaveAppOnlineSearchTable", oTable);
    ...
    addTotalRowCountSpanInDataTable("MyLeaveAppOnlineSearchTable");
}
