...
public class RestaurantConsumptionController : AppBaseController
{
    #region Config
    ...
    public RestaurantConsumptionController(IUnitOfWork iUnitOfWork,
    ...
    [HttpGet]
    //[Authorize(Permissions.RestaurantConsumption.Create)]
    ...
    [HttpGet]
    //[Authorize(Permissions.RestaurantConsumption.ListView)]
    [Authorize(Permissions.Module.RestaurantModule)]
    public async Task<IActionResult> Search()
    {
        ...
        if (resturantDpt == null)
        {
            SaveFailedMsg("Resturant Department Entry Not Found..!!");
            RedirectToAction("Index", "Home");
        }

        var vm = new TransactionSearchVm()
        {
            IssueDeptId = resturantDpt.Id,
    ...
    #region Detail
    //[Authorize(Permissions.RestaurantConsumption.Detail)]
    //[Authorize(Permissions.Module.RestaurantModule)]
