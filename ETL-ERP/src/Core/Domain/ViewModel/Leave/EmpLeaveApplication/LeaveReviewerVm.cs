namespace Domain.ViewModel.Leave.EmpLeaveApplication
{
    public class LeaveReviewerVm
    {
        ...
        public string SlNoText => SlNo switch { 1 => "FIRST APPROVER", 2 => "SECOND APPROVER", 3 => "THIRD APPROVER", 4 => "FOURTH APPROVER", 99 => "FINAL APPROVE", _ => "" };
